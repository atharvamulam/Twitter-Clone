...
const ExploreBar = () => {
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
    ...
    <input type="text" placeholder='Search' className='bg-transparent w-full px-2 focus:ring-0 outline-none'

    /> 
        </div>

        <div className='flex flex-col bg-slate-100 rounded-2xl my-3 h-fit'>
            <p className='font-black p-3 text-lg'>What's happening</p>
            {trending}
